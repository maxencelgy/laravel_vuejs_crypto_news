<template>
  <Div>
    <section class="pt-16 bg-purple-600">
      <div class="wrap top-flex pt-20 bg-purple-600 flex items-top justify-between  ">
        <div class="h-full" style="width: 39%">
          ...
          <div class="flex gap-4 items-center grp mb-6">
            <Link href="#selection"
        ...
        <div class="relative lottie lottie-hidden" style="height: 280px!important; width: 150%;">
    ...
    <div class="bg-purple-400 w-full view py-8 relative">
    ...
    <section class="bg-purple-600 pb-16 pt-8 relative">
      ...
      La boutique
        ...
        <br>
        <br>
      <div class="wrap !px-0 py-16 flex items-center justify-between phone">
        <div class="flex flex-col justify-center bas" style="width: 59%">
          <h2
