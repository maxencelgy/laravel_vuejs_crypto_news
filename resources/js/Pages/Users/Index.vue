    ...
    <div class="bg-white rounded-md shadow overflow-x-auto">
      <table class="w-full whitespace-nowrap">
        ...
        <tr v-for="user in users" :key="user.id" class="hover:bg-gray-100 focus-within:bg-gray-100">
          <td class="border-t">
            <Link class="flex items-center px-6 py-4 focus:text-indigo-500" :href="`/users/edit`">
          ...
          <td class="border-t">
            <Link class="flex items-center px-6 py-4" :href="`/users/edit`" tabindex="-1">
              {{ user.email }}
            </Link>
          </td>
          <td class="border-t">
          ...
          <td class="w-px border-t">
            <Link class="flex items-center px-4" :href="`/users/edit`" tabindex="-1">
