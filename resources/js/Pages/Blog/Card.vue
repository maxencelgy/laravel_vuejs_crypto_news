<template>
  <div style="width: 31.83%; word-wrap: break-word" class="mb-4 card-all hover:opacity-70  transition-all">
    <div class="relative">
...
<!--      <img class="rounded-2xl mb-4 h-72 w-full" :src="'/img/' + imageSrc" :alt="imageAlt">-->
      ...
      <span class="mt-2 text-base font-medium mr-2 px-2.5 py-0.5 rounded-full bg-purple-500 text-white">{{category}}</span>
