<template>
  ...
  <div class=" wrap flex items-start justify-between py-10 pb-16">
    <CardPricipale
      ...
      imageSrc="https://picsum.photos/1100/463"
      imageAlt=""
      date="À l'instant"
    ...
    />
    <div class="flex flex-col  items-center justify-between " style="width: 39%">
      ...
      <a href="#"
        ...
        <img class="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-l-lg"
             src="https://picsum.photos/800/500" alt="">
        <div>
...
export default {
  components: {SelectInput,CardPricipale, Link},
}
</script>
