  ...
  <div>
    <div class="mb-4">
      <Link class="group flex items-center py-3" href="/admin">
        <icon name="dashboard" class="mr-2 w-4 h-4" :class="isUrl('/admin') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'" />
        <div :class="isUrl('/admin') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">Dashboard</div>
      </Link>
    </div>
    <div class="mb-4">
