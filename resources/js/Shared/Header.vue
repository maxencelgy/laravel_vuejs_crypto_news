          ...
          <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul
              ...
              <li v-if="$page.props.auth.user">
                  ...
                  <Link class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent" :href="`/dashboard`">Dashboard</Link>
              </li>
              <li v-else>
                  <!-- Contenu à afficher si l'utilisateur n'est pas connecté -->
                  <Link class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent" :href="`/login`">Login</Link>
              </li>
              <li>
                <a href="#"
