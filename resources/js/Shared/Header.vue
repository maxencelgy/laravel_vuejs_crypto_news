      ...
      <nav class="z-80 bg-purple-600" :class="{ '!bg-purple-400 shadow': !showElement }">
        <div class="z-80 wrap flex flex-wrap items-center justify-between mx-auto p-2">
          ...
          <Link style="z-index: 99999" v-else
                class="not-hidden not-hidden-desktop text-black focus:outline-none transition-all  text-black uppercase bg-yellowFirst-600 hover:bg-yellowFirst-700 hover:text-white focus:ring-4 focus:ring-purple-300 font-semibold rounded-lg text-lg px-5 py-2.5 mb-2"
                :href="`/login`">
            S'inscrire / Se connecter
          </Link>
          <div style="z-index: 99999" class="is-hidden text-white" @click="activerShow" :class="{ '!hidden' : showMobileMenu }">
          ...
          <div style="z-index: 99999" class="not-hidden text-white" @click="desactiverShow" :class="{ 'is-hidden' : showMobileMenu }">
            <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 14 14">
              <path fill="none" stroke="#8B60ED" stroke-linecap="round" stroke-linejoin="round"
